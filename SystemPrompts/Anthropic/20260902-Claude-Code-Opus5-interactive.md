# Claude Code - Opus 5, interactive (unverified, partial)

- **Contributed by**: [xizhuomengcontin](https://github.com/xizhuomengcontin)
- **Contributed on**: 09/02/2026
- **Source**: Claude Code CLI v2.1.258.18d (from the billing header the request carried: `cc_version=2.1.258.18d`, `cc_entrypoint=cli`), interactive TTY session on Windows, model `claude-opus-5`. Public copy: [prompt/CLAUDECODE/claude-opus-5-system-prompt.md](https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/CLAUDECODE/claude-opus-5-system-prompt.md)
