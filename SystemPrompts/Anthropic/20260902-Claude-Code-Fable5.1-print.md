# Claude Code - Fable 5.1, `-p` / print mode (unverified, partial)

- **Contributed by**: [xizhuomengcontin](https://github.com/xizhuomengcontin)
- **Contributed on**: 09/02/2026
- **Source**: Claude Code CLI v2.1.258.18d in `-p` (print) mode on Windows, model `claude-fable-5-1`; the billing header on this one reports `cc_entrypoint=sdk-cli` rather than `cli`. Public copy: [prompt/CLAUDECODE/claude-fable-5-1-print-system-prompt.md](https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/CLAUDECODE/claude-fable-5-1-print-system-prompt.md)
