# opencode - GPT-5.6 (sol) through a self-hosted gateway (unverified, partial)

- **Contributed by**: [xizhuomengcontin](https://github.com/xizhuomengcontin)
- **Contributed on**: 09/02/2026
- **Source**: opencode `run` mode, model `gpt-5.6-sol` reached through a self-hosted gateway. Public copy: [prompt/OPENCODE/gpt-5-6-sol-system-prompt.md](https://github.com/Continuum-AI-Corp/OrcaReplay/blob/main/prompt/OPENCODE/gpt-5-6-sol-system-prompt.md)
