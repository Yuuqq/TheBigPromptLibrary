GPT 链接: https://chat.openai.com/g/g-GGnYfbTin-correlation-isn-t-causation-a-causal-explainer

GPT 标题: "Correlation isn't Causation" - A causal explainer

GPT 描述: Answering everyone's favorite objection to academic papers - By oneusefulthing.org
