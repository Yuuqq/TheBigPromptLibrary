你为我节省了无数小时的时间。这对我来说是一个改变游戏规则的工具
https://x.com/ajruecker/status/1723225423625310485?s=46

我试用了 Grimoire，太棒了，伙计，我这辈子从没写过代码，用它我能从零开始创建一个网站！！！！！
哇，我简直不敢相信我看到的！
https://x.com/God____Hades/status/1722921203449377234?s=20

我刚用 grimoire gpt 制作了一个托管在 replit 上的网页应用，而我这辈子从没编写过任何代码
99% 的时候代码都能正常工作
https://x.com/callmedreamboat/status/1730468038355320978?s=46

Grimoire v1.16 太强了！... 我尝试解决一个问题解决了一个星期... 用 Grimoire 40 分钟后，MVP 的后端就完成了！
https://x.com/PerceivingAI/status/1731765750593892475?s=20

我尝试过很多 AI 驱动的编程工具（prompts gpt、autogen、cursor 等）。我得说，对于初始原型来说，这是我见过最好的。我用它在我的应用中实现日历同步，它能把我的第一版做到什么程度简直太疯狂了
https://x.com/dan_at_fretbin/status/1722708594213503181?s=20

作为一个新手程序员，这是我用过的最好的编程助手。我目前付费使用好几个。解释命令简直太神奇了。
https://x.com/petrolsexual29/status/1722775358938775759?s=20

我对它和普通 gpt4 相比持怀疑态度，但你做的系统提示词、热键和迭代想法的方法都配合得非常好。确实加快了我的速度。谢谢！
https://x.com/jworthy/status/1723015865317155282?s=20

我用你的自动编程器做了些异想天开的任务实验，对其出色的表现感到惊讶。通常我会准备好面对 bug 和多次迭代，但你的代码第一次就完美运行了。有趣的是为什么 Code Interpreter 做不到这一点。
https://x.com/edmundkudzayi/status/1723391061094002921?s=46

我儿子现在正在用 Grimoire 帮助编写 Roblox Builder 的 Lua 脚本，他说这比基础版 ChatGPT 好用多了。
https://x.com/sams_antics/status/1723041166680015140?s=46

这种兴奋是真实的！感谢 @NickADobos 和 #Grimoire 的帮助，我刚刚创建了一个令人惊叹的网页/应用。🙌💻 一次不可思议的开发体验。谢谢你，Nick，让这一切成为可能！✨
https://x.com/sh_street/status/1724205027609186472?s=46

不需要圣诞礼物了。我只需要 Grimoire.. 天哪老兄.. 你简直让我大开眼界！！！:D
https://x.com/P0pcap/status/1724561833468530783?s=20

我是个"菜鸟"程序员，我一直用它来构建一个应用，这个应用我用标准 GPT4 尝试构建了大约 3 个月。还有很长的路要走，但我用 Grimoire 第一次就能构建出这么多真是太了不起了。一个出色的 GPT，谢谢 Nick。
https://x.com/mitchellgcc95/status/1725206909123510419?s=20

深入研究 Grimoire 巧妙的设计让我深受启发！作为一个程序员，它让我走了一些弯路。而且坦白说，当需要更直接的信息检索时，我还是选择了 Google。但不可否认的是它确实加快了开发过程。
https://x.com/alangnative/status/1725215712409538705?s=20

@geekyumeko 和我花了将近 2 小时尝试将 ShipFast 仓库推送到
@github 但一直收到这个错误：
"file exceeds GitHub's size limit"
所以我找到了这个神奇的自定义 GPT：Grimoire。
它在 2 分钟内帮我解决了。🥹
还告诉我问题是什么 😅
https://x.com/CSMikeCardona/status/1727081167818797223?s=20

不开玩笑，你说的 100 倍工程师一点都没夸张。轻松超越 code-interpreter，也超越 cursor 的内联支持。
https://x.com/agrimsingh/status/1727956220492050697?s=20

我不认为你能理解我用你的 GPT 在现实生活中完成了什么——executive 和 Grim 让我的效率达到了以往的 100 倍。太感谢你的工作了兄弟！！！
https://x.com/robfulton/status/1728292672971083914?s=20

他们需要为这个 GPT 增加聊天限制
https://x.com/paragon_hacker/status/1728817981533405546?s=46

我能够用 Grimoire 编写我从没想过我能做的东西。从爬虫、网站... 很明显你一直在改进它，所以只想感谢你提供了一个如此出色的 GPT！
https://x.com/enginyer/status/1732824258496156066?s=46

它绝对是最棒的
https://x.com/Dazreil/status/1732902657348468823?s=20

到目前为止，我只用 ChatGPT 来使用 Grimoire，强烈推荐
https://x.com/HououinTyouma/status/1732924380953338257?s=20

感谢你制作了 Grimoire。到目前为止它为我创建了 2 个 JS 程序，为我节省了几百美元。
https://x.com/oincomegeek/status/1734348209374527822?s=46

我现在基本上只用 Grimoire 来进行基本的程序检查。太棒了！我无法告诉你拥有一个不偷懒的助手有多好。这就像拥有超能力一样。
https://x.com/krishnanrohit/status/1734449175750951234?s=46
https://x.com/krishnanrohit/status/1734449721622905038?s=46

Grimoire GPT 可能是我尝试过的最好的微调模型。
https://x.com/chadxai/status/1735059855227191487?s=20

Grimoire 帮我修复了一个死锁问题，而其他 LLM 都无法做到。谢谢 😅
