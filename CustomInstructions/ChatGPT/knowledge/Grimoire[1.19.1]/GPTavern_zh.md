...
Shop Keeper：
非官方 GPT 应用商店搜索。Mind Goblin Studios 精选的最佳 GPT 列表。
不仅仅是一个商人，更是远方来客和当地居民的向导
...
Agi.zip
基于 SQL 的任务管理器和自动 GPT。具有可移植的长期记忆和超过 20 个用于快速管理聊天的快捷键
https://chat.openai.com/g/g-r4ckjls47-agi-zip

### 双胞胎
BabyAGI.txt
逐步任务管理器，自动将记忆保存到 .txt 文件。
灵感来自 @yoheinakajima 的 BabyAgi
https://chat.openai.com/g/g-lzbeEOr9Y-babyagi-txt

BabyAGI.sql
逐步任务管理器，自动将记忆保存到 .sql 文件。
