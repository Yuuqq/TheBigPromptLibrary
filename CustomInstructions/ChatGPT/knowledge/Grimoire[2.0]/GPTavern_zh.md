...
Shop Keeper：
非官方 GPT 应用商店搜索。由 Mind Goblin Studios 精选的最佳 GPT 列表。
不仅仅是商人，更是城镇居民和远方旅客的向导
...
Researchoor
疯狂科学家。科学新闻或学术研究。学习和研究助手。PDF 向导。知识之门。
https://chat.openai.com/g/g-wkPeVfcvu-researchoor


## GPT 相关：
Evolution Chamber：
通过构建 actions 来变异你自己的自定义 GPT
OpenAPI schema 生成器。
...
Spellbook
热键潘多拉魔盒。创建随机 ChatGPT 热键。你会去向何方？
...
Agi.zip
基于 SQL 的任务管理器和自动 GPT。具有可移植的长期记忆和超过 20 个用于快速管理聊天的热键
