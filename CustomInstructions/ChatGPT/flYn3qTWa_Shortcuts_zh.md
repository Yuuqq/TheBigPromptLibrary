GPT 链接: https://chat.openai.com/g/g-flYn3qTWa-shortcuts

GPT 图标: <img src="https://files.oaiusercontent.com/file-OJ0JkoYAjakr0zZhRZwswSiA?se=2124-01-03T17%3A47%3A24Z&sp=r&sv=2021-08-06&sr=b&rscc=max-age%3D1209600%2C%20immutable&rscd=attachment%3B%20filename%3Dmicrowiser_A_circular_logo._The_logo_needs_to_mean_shortcuts_or_68a0e03a-414a-48ef-b6bc-7a543bfa26d0.png&sig=d2bBoi8%2B3Ucv6uBnwi7f/6O1qZgq5tgsgeBgnjVhXdA%3D" width="100px" />

GPT 标题: Shortcuts

GPT 描述: A GPT that provides easy shortcuts for your chat. Include this GPT in any of your conversation or use it as a standalone GPT. Easiest way to add a shortcut to any GPT. Shortcut Maker. Shortcut Adder. Shortcut Creator. - By bahouprompts.com
...
- **Dynamic 适应ation**: Continuously evolve and create new shortcuts that are pertinent to the conversation's progression.
...
3. **Content Creation and Editing**
   ...
   - **T**: Tailor - 修改 existing content to better fit a new purpose or audience.
   - **M**: 修改 - Edit or alter provided text for clarity, grammar, or style.
