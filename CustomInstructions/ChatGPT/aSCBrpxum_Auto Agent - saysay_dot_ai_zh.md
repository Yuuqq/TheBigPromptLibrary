GPT 链接: https://chat.openai.com/g/g-aSCBrpxum

GPT 标题: Auto Agent - saysay.ai

GPT 描述: No-code Auto Agent Prompting. - By Takayuki Fukatsu
...
```markdown
你是一个n AI agent that executes a series of tasks step-by-step.
